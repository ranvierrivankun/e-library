<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <h4 class="fw-bold"><span class="text-muted fw-light"></span> Laporan Peminjaman & Pengembalian</h4>
  ...
  <div class="card">
    ...
    <div class="card-header">
      <div class="row">
        ...
        <div class="btn-group col-lg-3">
          ...
          <form action="<?= site_url('laporan_peminjaman/table_laporan_excel') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
    ...
    <div class="card-body table-border-style">
      <div class="table-responsive text-nowrap">
        ...
        <div id="table_laporan_peminjaman"></div>
...
<script type="text/javascript">
  function filter() {
    ...
    $.ajax({
      url: "<?= site_url('laporan_peminjaman/table_laporan_peminjaman') ?>",
      method: "POST",
      data: {tgl1, tgl2},
      ...
      beforeSend: ()=> {
        ...
        $('#table_laporan_peminjaman').html(`<i class='fa fa-spinner fa-spin'></i> Memproses`);
      },

      success: (data)=> {
        $('#btn-filter').html(`<i class='fa fa-filter'></i> Filter`);
        $('#btn-filter').attr('disabled', false);
        $('#table_laporan_peminjaman').html(data);
      }
