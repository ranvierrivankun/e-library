...
<form method="POST" id="form_tambah" enctype="multipart/form-data">
	...
	<div class="modal-body">
		...
		<div class="row g-2">
			<div class="col mb-2">
				<label for="emailLarge" class="form-label">Pilih Anggota yang meminjam</label>
...
<script>
	...
	$(".select_peminjaman").select2({
		...
		ajax: { 
			url: "<?= site_url('data_pengembalian/select_peminjaman')?>",
			type: "post",
			dataType: 'json',
			delay: 250,
...
/*Proses Tambah Buku*/
	$('#form_tambah').on('submit', function(e) {
		...
		Swal.fire({
			...
			if(result.value) {
				$.ajax({
					url: "<?= site_url('data_pengembalian/proses_tambah')?>",
					method: "POST",
