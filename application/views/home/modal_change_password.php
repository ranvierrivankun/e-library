...
<form method="POST" id="form_change_passwod" enctype="multipart/form-data">
...
<script type="text/javascript">
    $('#form_change_passwod').on('submit', function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if(result.value) {
                $.ajax({
                    url: "<?= site_url('home/proses_change_password') ?>",
                    method: "POST",
...
<script type="text/javascript">
    $('#password_baru_2').on('keyup', function(e) {
        ...
        if(pass2 == "") {
            ...
            $('#status_password_baru').html(`<span class='text-danger'>Password Baru Tidak Sama!, Ketik Ulang</span>`);
